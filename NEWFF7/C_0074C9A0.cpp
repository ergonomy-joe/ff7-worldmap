...
int C_0074CC07(struct t_wm_local_18 *bp08, struct SVECTOR *bp0c, struct t_wm_local_08 *bp10, short *bp14, struct t_wm_TerrainTriangle **bp18, short *bp1c, unsigned char bModelId/*bp20*/) {
	struct {
		int local_12;
		int local_11;
	...
	*lolo.local_6 = *bp0c;
	...
	if(bp10) {
		for(lolo.local_5 = &(bp10[0]); lolo.local_5 < &(bp10[6]) && lolo.local_3 <= 0; lolo.local_5 ++) {
			...
			if(C_0076085F(lolo.local_5->f_00, lolo.local_6, &lolo.local_1)) {
				...
				lolo.local_3 = -1;
				if(C_0074CECA(lolo.local_12, bModelId)) {//terrain/vehicle check?
	...
	if(lolo.local_3 == 0) {//else 0074CE8F
		for(lolo.local_8 = &(bp08->f_04[0]); lolo.local_8 < &(bp08->f_04[bp08->f_14]); lolo.local_8 ++) {
		...
		if(lolo.local_3) {//else 0074CE8F
			...
			if(C_0074CECA(lolo.local_12, bModelId) == 0) {//terrain/vehicle check?
				lolo.local_10 = 0;
				lolo.local_3 = 0;
			}
		}
...
int C_0074DB52(void);//get chocobo related parameter?

//terrain/vehicle check?
int C_0074CECA(int bp08, unsigned char bModelId/*bp0c*/) {
	struct {
		int bp_08;
		int bp_04;
	}lolo;
	...
	lolo.bp_04 = /*bp_0c*/
		...
		(C_00761735() == bModelId)//wm:current transportation mode?
	;
	switch(bModelId) {
		case WM_MODELID_00:
		case WM_MODELID_01:
		...
		case WM_MODELID_13:
			if(C_00766B53() == 2)
				return BIT_ISSET_2(0x21B6F83, bp08) && lolo.bp_08;
			return BIT_ISSET_2(0x4048008, bp08);
		case WM_MODELID_08:
			return BIT_ISSET_2(0x4040008, bp08);
		case 100:
			return (bp08 & 0x1f) == 7;
	}//end switch
...
//wm:set chocobo related parameter?
void C_0074DB45(int bp08) {
	D_00DE6B54 = bp08;
}

//get chocobo related parameter?
int C_0074DB52() {
	return D_00DE6B54;
}
...
int C_0074DB8C(int *bp08, int *pForField/*bp0c*/, int *pForBattle/*bp10*/, int bp14) {
	struct {
		int local_7;
		struct VECTOR local_6;
		int local_2;
	...
	if(D_00E045E4 < WM_MAINSTATE_9) {//else 0074E1E0
		...
		if(!D_00DE69E0) {//else 0074DE7C
			D_00E045E8 = /*lolo.local_8*/*bp08 != 0?
				C_00766C6E():
			...
			C_0074E1E9(
				/*lolo.local_11*/(*bp08 == 0 && *pForField >= 0x24 && *pForField <= 0x27)?
				(lolo.local_2 > 0)?10:9:
			...
			C_00750473();
			C_00766C7A(bp08, pForField, D_00E045E8 != 3);
			if(D_00E045E8 == 2)
			...
			C_007641A7();
			D_00DF5420 = (C_00761735() != WM_MODELID_03)?2000:4000;//wm:current transportation mode?
			if(*bp08 == 1 || *bp08 == 2 || D_00E045E4 == WM_MAINSTATE_7 || D_00E045E4 == WM_MAINSTATE_6)
				C_00767097();
			...
			if(!D_00E045EC) {//else 0074DFBF
				...
				if(D_00DFC48C != 2) {//else 0074DF6C
					D_00DE6A04 = /*lolo.local_16*/(C_00761F77() == 0 && lolo.local_1 <= 200)?
						/*lolo.local_15*/(lolo.local_1 > 50)?D_00DE6A04 + ((lolo.local_6.f_04 > D_00DE6A04)?50:-50):lolo.local_6.f_04:
			...
			if(!D_00E045EC) {//else 0074E16B
				...
				if(
					...
					if(D_00DE6A14 == 0 && D_00DE6A08 == 0) {//else 0074E0BB
						...
						else if(C_00761735() == WM_MODELID_03 || lolo.local_7 < 2000)//wm:current transportation mode?
		...
		if(D_00E045E4 >= WM_MAINSTATE_6) {//else 0074E1E0
			...
			while(C_0076603F())
				C_007641A7();
			C_007506B6();
			C_00767039(bp08, pForField, pForBattle);
			if(*bp08 == 1) {
				C_007538C9(3);
				C_0074FBCA();
			}
...
void C_0074EA48() {
	...
	lolo.dwDeltaY = 0;
	C_007616B3();
	lolo.local_10 = C_00761735();//wm:current transportation mode?
	if(D_00DE6B5C && D_00DFC4B8 <= 0 && C_0075335C()) {//else 0074F734
		...
		if(D_00DFC4B4 != 2 && D_00DFC4B4 != 3 && D_00E045E8 != 3 && (lolo.dwInputMask & (PAD_03|PAD_02)))
			C_0074D3D1(2);//wm:set view mode?
		if(lolo.local_10 == WM_MODELID_05 && (lolo.dwInputMask & PAD_06))
			lolo.dwInputMask &= ~0xf000;
		if(C_00761769(0x2000) && D_00DFC4B4 == 2 && D_00E045E8 != 2 && (lolo.dwInputMask & PAD_05))
			lolo.dwInputMask &= ~PAD_DOWN;
		if(C_00761844()) {
			lolo.local_3 = D_00DFC480 * 60;
			//goto 0074EB89
		} else {
			switch(lolo.local_10) {
				case WM_MODELID_03: lolo.local_3 = D_00DFC480 * 120; break;
				case WM_MODELID_05: lolo.local_3 = D_00DFC480 * 60; break;
				case WM_MODELID_06: lolo.local_3 = D_00DFC480 * 45; break;
				default:
					lolo.local_3 = D_00DFC480 * 30;
			}//end switch
		}
		if(
			((lolo.dwInputMask & PAD_00) && (D_00DFC470 & PAD_00) == 0) ||
			((lolo.dwInputMask & PAD_01) && (D_00DFC470 & PAD_01) == 0)
		) {
		...
		if(lolo.dwInputMask & PAD_UP) {
			if(D_00DF5430 == -1) {
				lolo.dwDeltaY = -lolo.local_3;
				D_00DF5430 = 0x800;
			} else {
				lolo.dwDeltaX = (lolo.dwDeltaX * 3) >> 2;
				lolo.dwDeltaY = (lolo.local_3 * -3) >> 2;
		...
		if(D_00DFC4B4 == 2 || D_00DFC4B4 == 3 || D_00E045E8 == 3) {//else 0074F4FE
			lolo.local_15 = /*lolo.local_34*/(D_00DFC4B4 == 3 && (lolo.dwInputMask & PAD_07));
			if(D_00E045E8 == 3) {//else 0074EDEF
				D_00DFC484 += C_00758B12(lolo.dwInputMask & 0xf000, /*lolo.local_35*/(lolo.dwInputMask & PAD_05) && (D_00DFC470 & PAD_05) == 0);
			...
			if(D_00DFC4B4 == 3 || D_00E045E8 == 2) {//else 0074F121
				lolo.local_32 = ((lolo.dwInputMask & (lolo.local_15?0xf000:0x20))?-1:0) & lolo.local_3;
				...
				if((lolo.dwInputMask & PAD_05) == 0)
					lolo.local_2 = 0;
			} else if(D_00DF5430 != -1) {
				C_00761B83(D_00DF5430 - D_00DFC484);
			}
			lolo.local_13.f_00 = lolo.dwDeltaX;
			lolo.local_13.f_02 = 0;
			lolo.local_13.f_04 = lolo.dwDeltaY;
			lolo.local_5.f_00 =
			lolo.local_5.f_04 = 0;
			...
			lolo.dwDeltaX = lolo.local_30.f_00;
			lolo.dwDeltaY = lolo.local_30.f_08;
			lolo.local_24 = 0;
			if(D_00DFC4B4 == 3 && lolo.local_15 == 0) {//else 0074F291
				C_00762798(&lolo.local_9);
				if(((lolo.dwInputMask & PAD_UP) && lolo.local_9.f_04 > 0x1f4 && D_00DE6A14 && C_00762136() != 0x1b) || lolo.local_9.f_04 > D_00DF5420) {
					C_00761F22(D_00DFC480 * -50);
					lolo.local_24 = 10;
				} else if((lolo.dwInputMask & PAD_DOWN) && lolo.local_9.f_04 < D_00DF5420 - D_00DFC480 * 50) {
					C_00761F22(D_00DFC480 * 50);
					lolo.local_24 = -10;
				}
			}
			if(D_00E045E8 == 2) {//else 0074F30B
				C_00762798(&lolo.local_9);
				if((lolo.dwInputMask & PAD_UP) && lolo.local_9.f_04 > -5000 && D_00DE6A14) {
					C_00761F22(D_00DFC480 * -30);
					lolo.local_24 = 10;
				}
				if((lolo.dwInputMask & PAD_DOWN) && lolo.local_9.f_04 < -3000) {
					C_00761F22(D_00DFC480 * 30);
					lolo.local_24 = -10;
				}
			}
		...
		//-- buggy engine noise? --
		if(lolo.local_10 == WM_MODELID_06) {//else 0074F57E
			if((lolo.dwInputMask & 0xf000) && (D_00DFC470 & 0xf000) == 0)
		...
		//-- --
		if(C_00761769(0x2000) && (lolo.dwInputMask & PAD_06) && (D_00DFC470 & PAD_06) == 0) {
			if(D_00E045E8 == 2 && C_00762136() == 3)//wm:get current terrain?
				C_0074D6BB();//go to surface
			else if(C_00762136() == 3)//wm:get current terrain?
				C_0074D6F6();//go to undersea
		}
		//-- map/radar state --
		if(
			(lolo.dwInputMask & PAD_11) && (D_00DFC470 & PAD_11) == 0 ||
			(lolo.dwInputMask & PAD_08) && (D_00DFC470 & PAD_08) == 0
		) {//else 0074F650
			C_0076831F(/*lolo.local_49*/(D_00E045E8 == 0)?(C_00768343() + 1) % 3:(!C_00768343() * 2));//wm:set map/radar state
		}
		//-- open menu/enter highwind --
		if((lolo.dwInputMask & PAD_04) && (D_00DFC470 & PAD_04) == 0 && D_00E045E4 == WM_MAINSTATE_1) {//else 0074F6C6
			if(lolo.local_10 == WM_MODELID_03) {
				C_007640BC(6);//wm:start script(2)?
			} else if(C_00761769(0x47) && C_00762136() != 0xe/*bridge?*/) {//wm:is current model in list(1)?//wm:get current terrain?
				C_00755B97(0x10, 1);//wm:start fade out?
				C_0074D438(0, 1);
				D_00E045E4 = WM_MAINSTATE_LEAVEWORLD;
				C_0074C980(0);//wm:set "allowsFrameSkip"?
