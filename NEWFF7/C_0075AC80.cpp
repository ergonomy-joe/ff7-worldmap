...
void C_0075AD28(struct t_local_unknown_c0 *bp08, int bp0c) {
	...
	if(bp08->f_50 == 3) {//else 0075B13E
		...
		if((lolo.local_2 == 1 || lolo.local_2 == 0x19) && (bp08->f_53 % 3) == 0) {//else 0075B5B5
			...
			C_006626BC(lolo.local_3, &lolo.local_22);//psx:y_rotate
			C_006625AB(lolo.local_9.f_00, &lolo.local_22);//psx:x_rotate
			C_006627CD(lolo.local_9.f_04, &lolo.local_22);//psx:z_rotate
			C_00663673(&lolo.local_22);//psx:SetRotMatrix?
			C_00662ECC(&D_00E2D1F8, &lolo.local_14, &lolo.local_1);//psx:RotTrans
...
unsigned char D_0096D6A8[][0xc] = {
	{0x81,0x01,0x20,0x20,0x00,0x20,0x0F,0x2F,0x00,0x00,0x00,0x00},
	{0x01,0x01,0x20,0x20,0x10,0x20,0x1F,0x2F,0x00,0x00,0x00,0x00},
	{0x01,0x01,0x20,0x20,0x20,0x20,0x2F,0x2F,0x00,0x00,0x00,0x00},
	{0x02,0x01,0x20,0x20,0x30,0x20,0x3F,0x2F,0x00,0x00,0x00,0x00},
	{0x02,0x01,0x20,0x20,0x40,0x20,0x4F,0x2F,0x00,0x00,0x00,0x00},
	{0x81,0x01,0x20,0x20,0x0F,0x20,0x00,0x2F,0x00,0x00,0x00,0x00},
	{0x01,0x01,0x20,0x20,0x1F,0x20,0x10,0x2F,0x00,0x00,0x00,0x00},
	{0x01,0x01,0x20,0x20,0x2F,0x20,0x20,0x2F,0x00,0x00,0x00,0x00},
	{0x02,0x01,0x20,0x20,0x3F,0x20,0x30,0x2F,0x00,0x00,0x00,0x00},
	{0x02,0x01,0x20,0x20,0x4F,0x20,0x40,0x2F,0x00,0x00,0x00,0x00},
	{0xFF,0x02,0x08,0x08,0x38,0x00,0x3F,0x0F,0x01,0x00,0x00,0x00},
	{0xFF,0x02,0x08,0x08,0x30,0x00,0x37,0x0F,0x01,0x00,0x00,0x00},
	{0xFF,0x02,0x10,0x10,0x00,0x00,0x0F,0x0F,0x02,0x00,0x00,0x00},
	{0x81,0x01,0x20,0x20,0x00,0x30,0x0F,0x3F,0x03,0x00,0x00,0x00},
	{0x01,0x01,0x20,0x20,0x10,0x30,0x1F,0x3F,0x03,0x00,0x00,0x00},
	{0x01,0x01,0x20,0x20,0x20,0x30,0x2F,0x3F,0x03,0x00,0x00,0x00},
	{0x82,0x01,0x20,0x20,0x00,0x10,0x0F,0x1F,0x04,0x00,0x00,0x00},
	{0x02,0x01,0x20,0x20,0x10,0x10,0x1F,0x1F,0x04,0x00,0x00,0x00},
	{0x03,0x01,0x20,0x20,0x20,0x10,0x2F,0x1F,0x04,0x00,0x00,0x00},
	{0x8A,0x05,0x00,0x00,0xC0,0x00,0xFF,0x3F,0x19,0x00,0x00,0x00},
	{0x83,0x00,0x20,0x20,0x80,0x80,0x9F,0x9F,0x05,0x00,0x00,0x00},
	{0x02,0x19,0x20,0x20,0xC0,0xA0,0xDF,0xBF,0x17,0x00,0x00,0x00},
	{0x02,0x19,0x20,0x20,0xE0,0x80,0xFF,0x9F,0x17,0x00,0x00,0x00},
	{0x02,0x19,0x20,0x20,0xC0,0x80,0xDF,0x9F,0x17,0x00,0x00,0x00},
...
void C_0075B8F3(short bp08, short bp0c, short bp10, int bp14) {
	...
	if(lolo.local_1) {
		...
		C_00663707(&lolo.local_13);//psx:SetTransMatrix?
		lolo.local_4.f_00 =
		lolo.local_4.f_04 = 0;
		lolo.local_4.f_02 = bp0c;
		C_006628DE(&lolo.local_4, &lolo.local_13);//psx:xyz_rotate(1)
		C_00663673(&lolo.local_13);//psx:SetRotMatrix?
		C_00662ECC(&D_00E2D1F0, &lolo.local_17, &lolo.local_5);//psx:RotTrans
		...
		C_006628DE(&lolo.local_4, &lolo.local_13);//psx:xyz_rotate(1)
		C_00663673(&lolo.local_13);//psx:SetRotMatrix?
		C_00662ECC(&D_00E2D1F8, &lolo.local_17, &lolo.local_5);//psx:RotTrans
		...
		lolo.local_1->f_1d = D_0096D6A8[lolo.local_1->f_1c][0] & ~0x80;
		lolo.local_1->f_04.f_0c = 0;
		for(lolo.local_2 = 0; lolo.local_2 < 2; lolo.local_2 ++) {
			lolo.local_1->f_20 = (D_0096D6A8[lolo.local_1->f_1c][1] & 0x1c) == 8?0:0x80;
			lolo.local_1->f_24.f_2c = (D_0096D6A8[lolo.local_1->f_1c][1] & 0x1c) == 8?0x80000000:0x80808080;
...
void C_0075BBB3(struct t_local_unknown_c0 *bp08, int bp0c) {
	...
	switch(bp0c) {
		...
		case 0x02:
			...
			D_00E2D1F0.f_00 = C_006624FD(lolo.bp_0c) >> 6;//psx:cos
...
void C_0075C283(struct t_wm_local_30 *, unsigned char *, struct SVECTOR *, short);
...
void C_0075C0FD() {
	...
	lolo.local_7.f_04 = 0;
	C_00662AD8(&lolo.local_7, &lolo.local_28);//psx:xyz_rotate(2)
	lolo.local_7.f_00 = -C_0074D3C6();
	C_00662AD8(&lolo.local_7, &lolo.local_19);//psx:xyz_rotate(2)
	...
	for(lolo.local_1 = D_00E35648; lolo.local_1; lolo.local_1 = lolo.local_1->f_00) {
		...
		if(lolo.local_10 > -0x7530 && lolo.local_10 < 0x7530 && lolo.local_20 > -0x7530 && lolo.local_20 < 0x7530) {
			...
			if(lolo.local_1->f_1e) {
				...
				C_006628DE(&lolo.local_7, &lolo.local_36);//psx:xyz_rotate(1)
				C_00663673(&lolo.local_36);//psx:SetRotMatrix?
			} else {
				C_00663673(&lolo.local_19);//psx:SetRotMatrix?
			}
...
void C_0075C283(struct t_wm_local_30 *bp08, unsigned char *bp0c, struct SVECTOR *bp10, short bp14) {
	struct {//x25c
	...
	lolo.bp_128.f_04 =
	lolo.bp_128.f_08 = 0;
	C_00663766(&lolo.bp_190, &lolo.bp_128);//psx:set translate vector?
	C_00663707(&lolo.bp_190);//psx:SetTransMatrix?
	lolo.bp_1a4.f_00 = (-bp0c[2]) * 8;
	if(bp14) {
		lolo.bp_1a4.f_02 = 0;
		lolo.bp_1a4.f_04 = (-bp0c[3]) * 8;
	} else {
		lolo.bp_1a4.f_02 = (-bp0c[3]) * 8;
		lolo.bp_1a4.f_04 = 0;
	}
	C_00662ECC(&lolo.bp_1a4, &lolo.bp_10, &lolo.bp_108);//psx:RotTrans
	lolo.bp_110.f_00 = lolo.bp_10.f_00;
	lolo.bp_110.f_02 = lolo.bp_10.f_04;
	lolo.bp_110.f_04 = lolo.bp_10.f_08;
	lolo.bp_1a4.f_00 += bp0c[2] * 16;
	C_00662ECC(&lolo.bp_1a4, &lolo.bp_10, &lolo.bp_108);//psx:RotTrans
	lolo.bp_118.f_00 = lolo.bp_10.f_00;
	lolo.bp_118.f_02 = lolo.bp_10.f_04;
	lolo.bp_118.f_04 = lolo.bp_10.f_08;
	if(bp14)
		lolo.bp_1a4.f_04 += bp0c[3] * 16;
	else
		lolo.bp_1a4.f_02 += bp0c[3] * 16;
	C_00662ECC(&lolo.bp_1a4, &lolo.bp_10, &lolo.bp_108);//psx:RotTrans
	...
	bp08->f_00.u0 = bp08->f_00.u2 = bp0c[4];
	bp08->f_00.u1 = bp08->f_00.u3 = bp0c[6];
	bp08->f_00.v0 = bp08->f_00.v1 = bp0c[5];
	bp08->f_00.v2 = bp08->f_00.v3 = bp0c[7];
	bp08->f_00.clut = FKMB(short, bp0c, 0x08);
	switch(bp0c[1] & 3) {
		case 0: bp08->f_28 = D_00E2C404; break;
		case 1: bp08->f_28 = D_00E2C408; break;
		case 2: bp08->f_28 = /*lolo.bp_1dc*/(FKMB(short, bp0c, 0x08) == 0x14)?D_00E2C408:D_00E2C404; break;
		case 3: bp08->f_28 = D_00E2C410; break;
		default: bp08->f_28 = D_00E2C404;
	}
	C_0074D3A7();
	C_00662ECC(bp10, &lolo.bp_10, &lolo.bp_108);//psx:RotTrans
	C_00663766(&lolo.bp_190, &lolo.bp_10);//psx:set translate vector?
	C_00663707(&lolo.bp_190);//psx:SetTransMatrix?
					...
					if(lolo.bp_19c >= 0 && lolo.bp_19c < 0x1000) {//else 0075CED9
						if(C_0066E272(1, bp08->f_28)) {//else 0075CED9
							if(C_0074C969()) {//get "isRendering"?//else 0075CED9
								...
								*(bp08->f_28->f_78) = bp08->f_00.clut;
								bp08->f_28->f_7c = bp08->f_00.clut;
							}
						}
					}
				}
...
//0075CF02
	while(lolo.bp_04) {//else 0075D43E
		...
		if(lolo.bp_08[1] == 2) {//else 0075D024
			lolo.bp_04->f_20 --;
			lolo.bp_14->f_00.r0 =
			lolo.bp_14->f_00.g0 =
			...
			*(int *)lolo.bp_10 = lolo.bp_14->f_2c;
			if(lolo.bp_04->f_1c == 0x7c) {//else 0075CFFD
				lolo.bp_10[0] --;//char
				lolo.bp_10[2] =//char
				lolo.bp_10[1] = lolo.bp_10[0];//char
			...
			switch(lolo.bp_08[1] & 0x1c) {
				...
				break;
				case 0x18:
					lolo.bp_08[3] += /*lolo.bp_1c*/(lolo.bp_08[2] < 0x20)?(lolo.bp_08[2] & 0xf)?3:-5:0;
					lolo.bp_08[2] = lolo.bp_08[3];
				break;
			}
		}
		lolo.bp_04->f_1d --;
		if(lolo.bp_04->f_1d == 0) {//else 0075D42B
			lolo.bp_04->f_1d = D_0096D6A8[++ lolo.bp_04->f_1c][0];
			if(lolo.bp_04->f_1d & 0x80) {//else 0075D42B
				if((lolo.bp_08[1] & 0x1c) == 0x18) {//else 0075D3C5
					while(((lolo.bp_04->f_1d = D_0096D6A8[-- lolo.bp_04->f_1c][0]) & 0x80) == 0);
...
void C_0075D482(struct t_wm_local_30 *bp08, short *bp0c) {
	...
	if(bp08 && bp0c) {
		for(local_1 = 0; local_1 < 1; local_1 ++) {
...
int _ocal_3[3];
	...
	C_006628DE(&lolo.local_22, &lolo.local_103);//psx:xyz_rotate(1)
	C_0066233D(&lolo.local_103, &lolo.local_87);//psx:...
	C_00663673(&lolo.local_87);//psx:SetRotMatrix?
	...
	if(lolo.local_108 >= 0 && lolo.local_108 < 0x1000 && C_0075F090(lolo.local_7[3]) > 0 && C_0075F090(lolo.local_17[3]) > 0 && C_0075F090(lolo.local_44[3]) > 0 && C_0075F090(lolo.local_52[3]) > 0) {//else 0075DEA6
		if(C_0066E272(1, bp18->f_28)) {//else 0075DEA6
			if(C_0074C969()) {//get "isRendering"?//else 0075DEA6
				...
				*(bp18->f_28->f_78) = bp18->f_00.clut;
				bp18->f_28->f_7c = bp18->f_00.clut;
			}
		}
	}
//0075DEA6
...
void C_0075E0BA(struct t_wm_b8 *bp08, struct t_local_unknown_c0 *bp0c, short bp10, short bp14, struct SVECTOR *bp18) {
	...
	bp08->f_44.f_10 *= 1.40625f;
	bp08->f_44.f_14 *= 1.40625f;
	bp08->f_44.f_18 *= 1.40625f;
	C_0075E029(&lolo.local_34);
	C_0075E062(&lolo.local_62, &(bp08->f_44.f_04), lolo.local_38);
	bp08->f_44.f_04.f_00 = lolo.local_38[0];
	bp08->f_44.f_04.f_04 = lolo.local_38[1];
	bp08->f_44.f_04.f_08 = lolo.local_38[2];
	C_0067BF2B(bp08->f_44.f_10, &lolo.local_18);//dx_mat:x_rotate(2)
	C_0067BFE6(bp08->f_44.f_14, &lolo.local_78);//dx_mat:z_rotate(2)
	...
	if(
		...
		lolo.local_146 = 0xff - ((lolo.local_46.f_12[2] / 4 - 0xfa0) >> 3);
		if(lolo.local_146 < 0)
			lolo.local_146 = 0;
		...
		lolo.local_163.f_08 = /*lolo.local_164 = */C_0066101A();//psx:get some color(2)
