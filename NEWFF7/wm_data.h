...
////////////////////////////////////////
struct t_wm_local_sRect {//size 8
	short wX,wY,wWidth,wHeight;
};

struct t_wm_file_TexUVCoord {//size 4
	unsigned short u,v;//tex coords u,v
};

//aka "struct t_wm_local_0c_xxx"
struct t_wm_FieldTblEntry {//size 0xc
	/*00*/short f_00;
	/*02*/short f_02;
	/*04*/short f_04;
	/*06*/short f_06;
...
struct t_wm_local_20_xxx {//size 0x20
	...
	/*0c*/unsigned short f_0c;
	/*0e*/unsigned short f_0e;
	/*10*/unsigned short f_10;
	/*12*/unsigned short f_12;
	/*14*/unsigned short f_14;
	/*16*/unsigned short f_16;
	/*18*/unsigned short f_18;
	/*1a*/unsigned short f_1a;
	/*1c*/unsigned short f_1c;
	/*1e*/char __1e[2];
};

struct t_wm_8a0 {//"enc_w.bin"//size 0x8a0
	/*000*/unsigned short f_000[8][2];//D_00DE6B78
	/*020*/unsigned short f_020[0x20][2];//D_00DE6B98
	/*0a0*/struct t_wm_local_20_xxx f_0a0[0x10][4];//D_00DE6C18
};
...
struct t_wm_SkyPoly {//size 0x34
	/*00*/struct POLY_G4 f_00;
	/*24*/unsigned bgra0;
	/*28*/unsigned bgra1;
	/*2c*/unsigned bgra2;
	/*30*/unsigned bgra3;
...
struct t_wm_local_08 {//size 8
	...
	/*04*/short wChunkX,wChunkY;
};

/*
f_03:
	+---+---+---+ +---+---+---+---+---+
	| script id | |    terrain type   |
	+---+---+---+ +---+---+---+---+---+
__0a:
	+---+---+---+---+---+---+---+---+
...
f_0b:
	+---+ +---+ +---+---+---+---+---+ +---+
	|cho| |flg| |    location id    | |tx8|
	+---+ +---+ +---+---+---+---+---+ +---+

cho: is this a chocobo location
flg: seems to be set/reset at runtime
*/
...
struct t_wm_TerrainChunkInfo {//size 0x18
	/*00*/struct t_wm_TerrainChunkInfo *pNext;
	//-- --
	/*04*/struct t_wm_TerrainTriangle *f_04;
	/*08*/struct SVECTOR *pVertices;
	/*0c*/struct SVECTOR *pNormals;
	/*10*/short wChunkX,wChunkY;
	/*14*/short wTriangleCount;
	/*16*/short wAge;
};

struct t_wm_local_30 {//size 0x30
	/*00*/struct POLY_FT4 f_00;
	/*28*/struct t_dx_sfx_e0 *f_28;
	/*2c*/unsigned f_2c;//color related
};

struct t_wm_ScriptStackElement {//size 4
	/*00*/short wScriptPC;
	/*02*/char bMoveCnt;
	/*03*/char bPriority;
};

struct t_local_unknown_c0 {//size 0xc0
	/*00*/struct t_local_unknown_c0 *pNext;
	/*04*/struct t_local_unknown_c0 *f_04;
	/*08*/struct t_local_unknown_c0 *f_08;
	/*0c*/struct VECTOR sPos,sPrevPos;
	/*2c*/struct t_wm_ScriptStackElement f_2c[4];
	/*3c*/short f_3c;//direction related
	/*3e*/short f_3e;
	/*40*/short f_40;//direction related
	/*42*/short f_42;
	/*44*/short f_44;//y?
	/*46*/short wScriptPC;//index in "WM?.EV"/+0x400
	/*48*/short f_48;
	/*4a*/short wTerrainInfo;
	/*4c*/short wDirection;
	/*4e*/short f_4e;
	...
	/*54*/unsigned char bStackDepth;
	/*55*/unsigned char bSpeed;
	/*56*/unsigned char bMoveCnt;
	/*57*/unsigned char bPriority;
	/*58*/unsigned char f_58;
	/*59*/unsigned char f_59;
	/*5a*/char __5a[2];
	/*5c*/char f_5c;//vertical speed(1)?
	/*5d*/char f_5d;
	/*5e*/char f_5e;//unused stuff?
	/*5f*/char f_5f;//vertical speed(2)?
	/*60*/struct t_wm_local_08 f_60[6];
	/*90*/struct t_wm_local_30 f_90;//rendering infos for shadow
};
////////////////////////////////////////
...
extern struct t_dx_sfx_e0 *D_00E2C404[4];
...
extern struct t_wm_file_TexUVCoord *D_00E2D168;//check
...
extern int D_00E37524;//[undersea fog]distance threshold?

extern int D_00E37D28;//[camera occlusion]distance threshold?
extern struct t_wm_FieldTblEntry D_00E37D30[];
extern struct t_wm_TerrainTriangle *D_00E38330;
extern D3DVECTOR D_00E38338[];
...
extern int C_0074CC07(struct t_wm_TerrainChunkInfo *, struct SVECTOR *, struct t_wm_local_08 *, short *, struct t_wm_TerrainTriangle **, short *, unsigned char);
...
extern int C_0074D319(void);//wm:get camera tilt angle?
extern void C_0074D323(int);//wm:set camera tilt angle?
extern int C_0074D330(void);//wm:get current map id?
extern void C_0074D33A(struct SVECTOR *);//wm:set trans matrix from svector?
extern void C_0074D3A7(void);//wm:set camera transform?
extern short C_0074D3C6(void);
extern void C_0074D3D1(int);//wm:set view mode?
extern void C_0074D438(int, int);//wm:set enable something?
extern int C_0074D4B6(void);//wm:get enable something?
extern void C_0074D4C0(short);
extern int C_0074D4DC(void);//wm:returns true[debug stuff?]
extern int C_0074D4ED(void);
extern void C_0074D4F7(int);//wm:set "highwind" state?
extern int C_0074D504(void);//wm:get "highwind" state?
extern void C_0074D50E(struct t_wm_b8 *, struct SVECTOR *, struct MATRIX *, int);
extern void C_0074D6BB(void);//wm:go to surface
extern void C_0074D731(int);//wm:go to field?
...
extern void C_0074DB45(int);//wm:set chocobo tint?
extern int C_0074DB8C(int *, int *, int *, int);
//-- C_0074FFC0.cpp --
extern void C_00750134(struct VECTOR *, struct SVECTOR *, short *, short *);//wm:world to chunk coordinates?
extern void C_00750202(struct VECTOR *);//wm:clamp x,z?
extern void C_0075027C(struct VECTOR *, int);//wm:set some pos?
extern void C_0075042B(struct VECTOR *);//wm:get some pos?
extern int C_0075045C(void);//wm:get bridge move counter?
extern void C_00750466(int);//wm:set bridge move counter?
extern void C_00750473(void);//wm:terrain init/reset stuff?
extern void C_007506B6(void);
extern void C_007506C0(void);
extern void C_00750784(void);
extern void C_0075079D(short, int);//wm:refresh terrain stuff?
extern void C_0075334D(void);//wm:set chocobo farm related flag?
extern int C_0075335C(void);//wm:allow control/move?
extern int C_00753366(short, short);//wm:(for midgar zolom)
extern void C_007533AF(void);//wm:map init/reset?
extern void C_0075378A(int);//wm:some patch for submarine?
extern void C_007537A1(int);//wm:set world map state?
...
extern int C_007538C9(short);//wm:start something(unused)?
extern void C_0075395E(short);//wm:stop something(unused)?
...
extern struct t_wm_SkyPoly *C_007540E5(void);
...
extern void C_00755F95(void);//wm:midgar zolom related.init/reset?
extern void C_0075611B(void);//wm:reset Midgar Zolom?
extern int C_007561EC(void);//wm:is in marshlands?
extern void C_007561F6(struct t_wm_TerrainChunkInfo *);//wm:Midgar Zolom related(2)
extern void C_007562FF(void);//wm:refresh Midgar Zolom stuff?
extern void C_00756A95(void);
extern void C_00756B0C(struct t_wm_TerrainChunkInfo *);
extern void C_00756FF9(struct t_wm_TerrainChunkInfo *, struct t_wm_TerrainTriangle *);//wm:chocobo farm related?
extern void C_007570E8(int);
extern void C_007573D9(void);//wm:chocobo related refresh?
extern void C_00758A32(int);
extern int C_00758A3F(void);
extern int C_00758A6C(void);
extern void C_00758AC4(int);//wm:set snowpole indice?
extern int C_00758B12(int, int);
extern int C_00758D0B(void);//wm:get snowpole indice?
...
//-- wmfile.cpp --
extern int C_007592E0(int);//wmfile:texture is animated?
...
extern void C_0075AD28(struct t_local_unknown_c0 *, int);//wm:terrain, vehicle 2D fx?
...
extern void C_0075D482(struct t_wm_local_30 *, struct t_wm_local_sRect *);//wm:set model's texture coords?
...
extern void C_0075E024(struct t_wm_b8 *);//wm:<empty>
...
//-- C_0075F090.cpp --
extern int C_0075F090(float);//wm:float to int
extern void C_0075F0AD(struct SVECTOR *, int);//wm:send terrain vertices for rendering?
extern void C_0075F263(void);//wm:2d clip terrain vertices?
...
extern void C_00761644(short, short);//wm:chunk unloaded?
extern void C_007616B3(void);//wm:set some info(1)?
extern void C_007616CB(void);//wm:set some info(2)?
extern struct t_wm_local_08 *C_007616E3(void);
extern int C_0076170B(void);//wm:get model type(1)?
...
extern void C_00762102(int);//wm:set model type?
extern void C_0076211B(int);//wm:set terrain info?
extern int C_00762136(void);//wm:get current terrain?
extern int C_00762162(void);//wm:get location id?
extern int C_00762191(void);//wm:is chocobo location?
extern int C_007621C0(void);//wm:current terrains's script?
...
extern void C_00762763(struct VECTOR *);//wm:get model pos(1)?
extern void C_00762798(struct VECTOR *);//wm:get model pos(2)?
extern void C_007627CD(struct VECTOR *);//wm:get model previous pos(1)?
extern void C_00762802(struct VECTOR *);//wm:get model previous pos(2)?
...
extern void C_00762D74(struct t_wm_TerrainChunkInfo *);
extern void C_00762E87(int, int);
extern void C_00762F75(int, int, int);//wm:set model tilt x,y,z?
...
extern void C_00763D6C(int);//wm:set enable/disable script?
extern void C_00764014(int, int);//wm:start script(1)?
extern void C_007640BC(int);//wm:start script(2)?
extern void C_007641A7(void);//wm:execute scripts?
extern void C_00765F61(void);//wm:refresh script stuff?
extern int C_0076603F(void);
extern void C_0076609E(void);
extern void C_00766255(int, int);//wm:update characters list for script?
...
extern void C_007667A3(void);//wm:start "leave vehicle"?
extern void C_007667B2(int);//wm:manage ride/leave vehicle?
extern int C_00766B53(void);//wm:get "leave vehicle" state?
extern void C_00766B5D(int);
//-- C_00766B70.cpp --
extern int C_00766B9F(void);
extern int C_00766C33(void);
extern int C_00766C6E(void);//wm:get saved map id?
...
extern void C_007670F9(int);//wm:field infos related?
extern void C_0076717C(int);
extern void C_007671AD(int);//wm:set countdown?
extern void C_007671E1(void);
extern int C_00767204(void);//wm:get last module id?
extern int C_0076720E(void);//wm:get last field id?
...
extern void C_00767533(int);//wm:set random inhibits encounter?
